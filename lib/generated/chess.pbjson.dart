...
const MoveRequest$json = const {
  '1': 'MoveRequest',
  '2': const [
    const {'1': 'move', '3': 1, '4': 1, '5': 9, '10': 'move'},
  ],
};

/// Descriptor for `MoveRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List moveRequestDescriptor = $convert.base64Decode('CgtNb3ZlUmVxdWVzdBISCgRtb3ZlGAEgASgJUgRtb3Zl');
...
final $typed_data.Uint8List moveResponseDescriptor = $convert.base64Decode('CgxNb3ZlUmVzcG9uc2USFgoGc3RhdHVzGAEgASgIUgZzdGF0dXM=');
